...
const int nLiftMotor1                   =   7;      // Left Climb Motor         (TALON FX/FALCON 500)
const int nLiftMotor2                   =   8;      // Right Climb Motor        (TALON FX/FALCON 500)
const int nPneumatics                   =   9;      // CTRE Pneumatics Control Module
