...
const int nIntakeMotor1                 =  7;      // Intake motor one       (SPARK MAX controller) NOTE: config unkown, labels will be determined later
const int nIntakeMotor2                 =  3;      // Intake motor two        |
